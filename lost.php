...
<body>
  <div class="container">
    ...
    <br>
    <hr>
    <h2>Lost an item? Add it here!</h2>
    <hr>
    <div class="form-group" style="text-align:center">
      <form class="form-group"  action="lost.php" method="post">
          ...
          <fieldset class="form-group">
            <input class="form-control" type="text" name="building" placeholder="Building Lost In"><br><br>
          </fieldset>
          <fieldset class="form-group">
            <input class="form-control" type="text" name="room" placeholder="Room Lost in"><br><br>
          </fieldset>      
  ...
  <?php
    ...
    if ($_SERVER[ 'REQUEST_METHOD' ] == 'POST' ) {
      ...
      if( !empty( $errors ) ) {
        ...
        # inserts user input into the database if all fields are input
          ...
          insert_record($dbc, $finder, $description, $building, $room, $lost);
    ...
    <?php    
        ...
        if(isset($_GET['id']))
            display_lost_found_item($dbc, $_GET['id'], "lost");
    } 
  ?>
    </div>
</body>
